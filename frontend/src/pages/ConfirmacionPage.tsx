...
const ConfirmacionPage = () => {
  ...
  if (!pedido) {
    return (
      <div className="bg-confirmacion">
        <div className="container py-5 text-center">
          <h3 style={{ color: "var(--color-900)" }}>No hay información del pedido</h3>
          ...
          <div className="col-lg-7">
            ...
            >
              ...
              {pedido.items.map((item) => (
                ...
                >
                  <div>
                    <span style={{ color: "var(--color-900)", fontWeight: "var(--font-medium)", fontSize: "var(--text-sm)" }}>
                      {item.nombreProducto}
                    </span>
                    <small className="d-block" style={{ color: "var(--color-800)" }}>
                      {item.cantidad} x {formatCurrency(item.precioUnitario)}
                    </small>
                  </div>
                  <span style={{ color: "var(--color-900)", fontWeight: "var(--font-semibold)", fontSize: "var(--text-sm)" }}>
              ...
              >
                <span style={{ color: "var(--color-900)", fontWeight: "var(--font-bold)", fontSize: "var(--text-md)" }}>
                  Total pagado
                </span>
                <span style={{ color: "var(--color-900)", fontWeight: "var(--font-bold)", fontSize: "var(--text-md)" }}>
